...
public class DiaDia {
	...
	private boolean processaIstruzione(String istruzione) {
		...
		Comando comandoDaEseguire = new Comando(istruzione);
		 ...
		 if 
		(comandoDaEseguire.getNome().equals("fine")) {
		...
		else if (comandoDaEseguire.getNome().equals("posa")||comandoDaEseguire.getNome().equals("lascia"))
	...
	private void prendi(String nomeAttrezzo) {
		...
		if(partita.getGiocatore().getBorsa().addAttrezzo(attrezzo)) {
			...
			if(partita.getLabirinto().getStanzaCorrente().removeAttrezzo(attrezzo.getNome())) {
				
				IO.mostraMessaggio(" "+nomeAttrezzo+" aggiunto nella borsa"); 
			...
			IO.mostraMessaggio(" "+nomeAttrezzo+" Non presente in stanza"); 
		}
